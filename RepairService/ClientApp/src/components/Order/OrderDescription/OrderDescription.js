    ...
    OrderDescription.prototype.render = function () {
        return (React.createElement("div", { className: "border-bottom mb-1" },
            ...
            React.createElement("form", null,
                ...
                React.createElement("input", { type: "text", className: "form-control form-control-lg w-25", id: "ShortDesc", "aria-describedby": "orderShortDescHelp" }),
                ...
                React.createElement("textarea", { className: "form-control form-control-lg w-50 mb-1", id: "FullDesc", "aria-describedby": "orderShortDescHelp" }),
